      ...
      <div className="flex min-h-[80px] items-center justify-between px-4">
        <div className="flex items-center gap-3">
          ...
          <button
            disabled
            type="button"
            className="flex h-[34px] items-center gap-2 rounded-lg border border-gray-500 bg-gray-100 p-2 text-[14px] text-gray-400"
          >
            <Search size={16} />
            <span className="text-sm opacity-0">패스 검색</span>
          </button>
        </div>
        <div className="flex items-center gap-3">
