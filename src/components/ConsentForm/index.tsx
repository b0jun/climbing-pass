...
const formInit = () => {
	...
	const validations = {
		name: yup
			...
			.max(30, '이름이 너무 길어요.'),
		phoneNumber: yup.string().required('휴대폰 번호를 입력해주세요.').min(10, '휴대폰 번호를 정확히 입력해주세요.'),
		dateOfBirth: yup
			.string()
	...
	return (
		<FormProvider {...methods}>
			<div className="px-5 mt-5">
				<h1 className="mt-4 mb-6 text-xl font-bold text-center">{`돌멩이 클라이밍 일일${passType} 동의서`}</h1>
